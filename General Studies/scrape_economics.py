...
BASE_URL = "https://www.examveda.com/general-knowledge/practice-mcq-question-on-indian-economy/"
...
def main():
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'economics_mcqs_scraped.json')
