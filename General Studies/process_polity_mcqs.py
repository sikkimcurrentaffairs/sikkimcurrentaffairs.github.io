...
CATEGORIES = {
    "Constitutional Framework": [
        "constitution", "preamble", "schedule", "part", "article", "amendment", 
        "citizenship", "fundamental right", "directive principle", "dpsp", "fundamental duty", 
        "feature", "source", "drafting", "assembly", "constituent assembly", "writ", "basic structure"
    ],
    "Central Government": [
        "president", "vice-president", "prime minister", "pm", "council of minister", 
        "cabinet", "parliament", "lok sabha", "rajya sabha", "mp", "speaker", "chairman", 
        "bill", "budget", "motion", "question hour", "zero hour", "attorney general", "solicitor general"
    ],
    "State Government": [
        "governor", "chief minister", "cm", "state legislature", "assembly", 
        "council", "vidhan", "mla", "mlc", "advocate general"
    ],
    "Judiciary": [
        "supreme court", "high court", "judge", "chief justice", "cji", "judicial", 
        "subordinate court", "tribunal", "lok adalat", "pil"
    ],
    "Local Government": [
        "panchayat", "municipality", "municipal", "73rd", "74th", "local self", 
        "gram sabha", "mayor", "sarpanch", "zila", "district planning"
    ],
    "Constitutional & Non-Constitutional Bodies": [
        "election commission", "upsc", "spsc", "finance commission", "cag", 
        "niti aayog", "planning commission", "nhrc", "human right", "cvc", 
        "cbi", "lokpal", "lokayukta", "inter-state", "zonal council"
    ]
}
...
def classify_question(text):
    ...
    for cat, keywords in CATEGORIES.items():
        for kw in keywords:
            # Word boundary check for cleaner matches
...
<body>
    ...
    <div id="quiz-container">
        <a href="indian_polity.html" class="back-link">&larr; Back to Indian Polity</a>
        <h1>{title}</h1>
...
def generate_landing_page(sections):
    ...
    cards_html = ""
    colors = [
        ("indigo", "600"), ("blue", "600"), ("sky", "600"), ("cyan", "600"),
        ("teal", "600"), ("emerald", "600"), ("green", "600"), ("lime", "600"),
        ("amber", "600"), ("orange", "600"), ("rose", "600"), ("pink", "600"),
        ("fuchsia", "600"), ("purple", "600"), ("violet", "600"),
    ]
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Indian Polity MCQs | Sikkim PSC Hub</title>
...
<body class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl sm:text-5xl font-bold text-sky-800 dark:text-sky-300 mb-4">Indian Polity MCQs (Examveda)</h1>
            <p class="text-lg text-gray-600 dark:text-gray-400">Comprehensive Indian Polity MCQs for Sikkim PSC & Competitive Exams</p>
...
# ============================================================
def main():
    if not os.path.exists('polity_mcqs_scraped.json'):
        print("Scraped file not found!")
        return

    with open('polity_mcqs_scraped.json', 'r', encoding='utf-8') as f:
    ...
    # Output Directory
    output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'Polity')
    ...
    with open(os.path.join(output_dir, 'indian_polity.html'), 'w', encoding='utf-8') as f:
        f.write(landing_html)
        
    print("Generated indian_polity.html landing page.")
