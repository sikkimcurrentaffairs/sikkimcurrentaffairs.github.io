...
BASE_URL = "https://www.examveda.com/general-knowledge/practice-mcq-question-on-physics/"
...
def main():
    all_qs = []
    # Scrape all 15 sections
    for s_id in range(1, 16):
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'physics_mcqs_scraped.json')
