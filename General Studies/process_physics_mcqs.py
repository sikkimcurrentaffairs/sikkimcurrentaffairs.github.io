...
# Topic configuration for Physics
TOPICS = [
    {
        "name": "Mechanics",
        "slug": "mechanics",
        "keywords": ["force", "motion", "gravity", "acceleration", "velocity", "momentum", "work", "energy", "power", "friction", "torque", "inertia", "mechanic", "keppler", "newton's law", "projectile", "centripetal"],
        "icon": "mechanics"
    },
    {
        "name": "Heat & Thermodynamics",
        "slug": "heat___thermodynamics",
        "keywords": ["heat", "temperature", "thermodynamic", "entropy", "conduction", "convection", "radiation", "thermal", "boiling", "freezing", "specific heat", "calorimeter", "carnot", "isothermal", "adiabatic"],
        "icon": "thermometer"
    },
    {
        "name": "Waves, Sound & Light",
        "slug": "waves_sound___light",
        "keywords": ["wave", "sound", "light", "optic", "lens", "mirror", "refraction", "reflection", "frequency", "amplitude", "wavelength", "doppler", "laser", "interference", "diffraction", "polarization", "concave", "convex", "spectrum"],
        "icon": "sun"
    },
    {
        "name": "Electricity & Magnetism",
        "slug": "electricity___magnetism",
        "keywords": ["electric", "magnet", "current", "voltage", "resistance", "ohm", "faraday", "ampere", "capacitor", "transformer", "circuit", "field", "induction", "conductor", "insulator", "semiconductor", "charge", "coulomb"],
        "icon": "bolt"
    },
    {
        "name": "Atomic & Nuclear Physics",
        "slug": "atomic___nuclear_physics",
        "keywords": ["atomic", "nuclear", "proton", "neutron", "electron", "radioactive", "fission", "fusion", "isotope", "quantum", "photoelectric", "x-ray", "alpha", "beta", "gamma", "nucleus", "bohr", "einstein", "relativity"],
        "icon": "beaker"
    },
    {
        "name": "General Physics",
        "slug": "general_physics",
        "keywords": ["unit", "measurement", "dimension", "scalar", "vector", "pressure", "density", "viscosity", "surface tension", "buoyancy", "archimedes", "bernoulli", "matter", "solid", "liquid", "gas"],
        "icon": "cube"
    },
    {
        "name": "Astrophysics & Space Science",
        "slug": "astrophysics___space_science",
        "keywords": ["planet", "star", "galaxy", "universe", "comet", "asteroid", "satellite", "orbit", "telescope", "black hole", "nebula", "solar", "lunar", "eclipse", "constellation", "space"],
        "icon": "globe-alt"
    }
]
...
<body class="bg-slate-50 dark:bg-slate-900 min-h-screen p-4 sm:p-8">
    ...
    <div class="quiz-container">
        <a href="physics.html" class="back-link">&larr; Back to Physics Topics</a>
        <h1 class="text-3xl font-bold text-blue-800 dark:text-blue-400 mb-2">{title}</h1>
...
{quiz_data_js}
        ...
        quizData.forEach((item, index) => {{
            ...
            questionText.innerHTML = `<span class="text-blue-600 dark:text-blue-500 mr-2">Q${{index + 1}}.</span> ${{item.question}}`;
...
def generate_landing_page(sections):
    ...
    cards_html = ""
    colors = [
        ("blue", "600"), ("sky", "600"), ("indigo", "600"), ("violet", "600"),
        ("purple", "600"), ("fuchsia", "600"), ("pink", "600"), ("rose", "600"),
        ("amber", "600"), ("orange", "600"), ("emerald", "600"), ("teal", "600"),
    ]
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Physics MCQs | Sikkim PSC Hub</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script>
        tailwind.config = {{
            darkMode: 'class',
...
<body class="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        <div class="mb-8">
            <a href="../index.html" class="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">&larr; Back to Home</a>
        </div>
        
        <div class="text-center mb-12">
            <h1 class="text-4xl sm:text-5xl font-bold text-blue-800 dark:text-blue-400 mb-4">Physics MCQs (Examveda)</h1>
            <p class="text-lg text-gray-600 dark:text-gray-400">High-quality Physics MCQs for Sikkim PSC & Competitive Exams</p>
...
def main():
    json_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'physics_mcqs_scraped.json')
    ...
    # Generate HTML files
    sections_info = []
    output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'Physics')
    ...
    with open(os.path.join(output_dir, 'physics.html'), 'w', encoding='utf-8') as f:
        f.write(landing_html)
    print("Generated physics.html landing page.")
