...
BASE_URL = "https://www.examveda.com/general-knowledge/practice-mcq-question-on-environmental-science/"
...
def main():
    all_qs = []
    # Scrape Sections 1 to 9 as requested
    for s_id in range(1, 10):
        print(f"Starting Section {s_id}...", flush=True)
        for p_id in range(1, 20): # Safe upper bound for pages per section
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ecology_mcqs_scraped.json')
